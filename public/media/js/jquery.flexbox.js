...
* Modified by Dimosthenis Nikoudis <dnna@dnna.gr>
*
...
(function($) {
    $.flexbox = function(div, o) {
		...
		$div.css('height', $input.outerHeight() + 1);
        ...
        function flexbox(p, arrowOrPagingClicked, prevQuery) {
            ...
            if (q.length >= o.minChars || arrowOrPagingClicked) {
                ...
                if (cached) {
                    ...
                    params = $.extend({}, params, o.extraParams);
                    var callback = function(data, overrideQuery) {
                        $input.removeClass('ac_loading'); // ADDED BY dnna@dnna.gr
					...
					if (typeof (o.source) === 'object') {
						...
						else { // ADDED BY dnna@dnna.gr
                                                    $input.addClass('ac_loading'); // ADDED BY dnna@dnna.gr
                                                    $.getJSON(o.source, params, callback);
                                                } // ADDED BY dnna@dnna.gr
					}
                }
            } else
                hideResults();

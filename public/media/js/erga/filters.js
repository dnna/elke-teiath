$(document).ready(function() {
    ...
    $("#filters-search-elementPopUp").qtip({content: 'Η αναζήτηση αφορά τα πεδία "Κωδικός Έργου", "Κωδικός Λογιστηρίου", "Τίτλος" και "Επιστημονικά Υπεύθυνος" ',show: { when: { event: 'mouseenter' }}})
});
 ...
 * @Entity @Table(name="elke_aitiseis.aode_budgetitems")
 */
class Aitiseis_Model_OikonomikiDiaxeirisi_Ergou_BudgetItem extends Application_Model_SubObject {
    /**
     * @ManyToOne (targetEntity="Aitiseis_Model_OikonomikiDiaxeirisi_Ergou", inversedBy="_budgetitems")

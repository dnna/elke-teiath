 ...
 */
class Api_Erga_Ypoerga_AnadoxoiController extends Api_IndexController
{
    const name = 'Ανάδοχοι';
    ...
    public function getAction() {
        $object = Zend_Registry::get('entityManager')->getRepository('Erga_Model_SubItems_SubProjectContractor')->find($this->_request->getParam('id'));
        if(!isset($object)) {
    ...
    public function deleteAction() {
        ...
        $this->_helper->Delete($this, 'Erga_Model_SubItems_SubProjectContractor', $this->_request->getParam('id'));
    }

    public function schemaAction() {
        echo $this->_helper->generateXsd($this, new Erga_Form_Apasxoloumenoi_Contractor($this->view), 'contractor');
    }
}
?>
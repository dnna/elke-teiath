...
class Api_Erga_ApasxoloumenoiController extends Api_IndexController
{
    ...
    public function indexAction() {
        ...
        } else if($auth->getStorage()->read()->hasRole('elke') || ($auth->getStorage()->read()->hasRole('professor') && ($subproject instanceof Erga_Model_SubProject && $subproject->get_subprojectsupervisor()->get_userid() == $auth->getStorage()->read()->get_userid()) || ($subproject instanceof Erga_Model_Project && $subproject->get_basicdetails()->get_supervisor()->get_userid() == $auth->getStorage()->read()->get_userid()))) {

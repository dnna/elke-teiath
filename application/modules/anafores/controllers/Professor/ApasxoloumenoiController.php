 ...
 */
class Anafores_Professor_ApasxoloumenoiController extends Zend_Controller_Action {
    ...
    public function overviewAction() {
        ...
        $auth = Zend_Auth::getInstance();
        $overview = Zend_Registry::get('entityManager')->getRepository('Erga_Model_SubItems_SubProjectEmployee')->getOverview($employee[0], array_merge($this->_request->getParams(), array('supervisoruserid' => $auth->getStorage()->read()->get_userid())));

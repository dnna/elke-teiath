 ...
 */
class Timesheets_Model_Timesheet extends \Timesheets_Model_Timesheet implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', '_id', '_month', '_year', '_approved', '_employee', '_project', '_activities');
    }

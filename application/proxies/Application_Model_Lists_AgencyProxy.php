 ...
 */
class Application_Model_Lists_AgencyProxy extends \Application_Model_Lists_Agency implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', '_id', '_name', '_address', '_afm', '_doy');
    }

 ...
 */
class Erga_Model_SubItems_Deliverable extends \Erga_Model_SubItems_Deliverable implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', '_codename', '_title', '_amount', '_startdate', '_enddate', '_assignmentapprovaldate', '_completionapprovaldate', '_comments', '_recordid', '_workpackage', '_authors', '_contractor', '_timesheetactivities', '_limits');
    }

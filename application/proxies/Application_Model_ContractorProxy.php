 ...
 */
class Application_Model_ContractorProxy extends \Application_Model_Contractor implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', '_afm', '_doy', '_name', '_address', '_contracts');
    }

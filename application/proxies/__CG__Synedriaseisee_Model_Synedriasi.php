 ...
 */
class Synedriaseisee_Model_Synedriasi extends \Synedriaseisee_Model_Synedriasi implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', '_num', '_id', '_start', '_end', '_subjects');
    }

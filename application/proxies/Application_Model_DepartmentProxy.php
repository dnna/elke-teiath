 ...
 */
class Application_Model_DepartmentProxy extends \Application_Model_Department implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::get_school();
    }

    public function set_school($_school)
    {
        $this->__load();
        return parent::set_school($_school);
    }
    ...
    {
        $this->__load();
        return parent::get_lname();
    }

    public function set_lname($_lname)
    {
        $this->__load();
        return parent::set_lname($_lname);
    }

    public function get_gramm()
    {
        $this->__load();
        return parent::get_gramm();
    }

    public function set_gramm($_gramm)
    {
        $this->__load();
        return parent::set_gramm($_gramm);
    }
    ...
    {
        return array('__isInitialized__', '_id', '_school', '_name', '_lname', '_gramm');
    }

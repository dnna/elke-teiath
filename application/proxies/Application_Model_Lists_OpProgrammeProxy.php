 ...
 */
class Application_Model_Lists_OpProgrammeProxy extends \Application_Model_Lists_OpProgramme implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function get_opprogrammeid()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["_opprogrammeid"];
        }
        $this->__load();
        return parent::get_opprogrammeid();
    }

    public function set_opprogrammeid($_opprogrammeid)
    {
        $this->__load();
        return parent::set_opprogrammeid($_opprogrammeid);
    }

    public function get_opprogrammename()
    {
        $this->__load();
        return parent::get_opprogrammename();
    }

    public function set_opprogrammename($_opprogrammename)
    {
        $this->__load();
        return parent::set_opprogrammename($_opprogrammename);
    }
    ...
    {
        return array('__isInitialized__', '_opprogrammeid', '_opprogrammename', '_fundingframework');
    }

 ...
 */
class Synedriaseisee_Model_AitisiSubject extends \Synedriaseisee_Model_AitisiSubject implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', '_num', '_recordid', '_synedriasi', '_aitisi');
    }

 ...
 */
class Synedriaseisee_Model_AitisiSubjectProxy extends \Synedriaseisee_Model_AitisiSubject implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::get_titlewithnum();
    }
    ...
    {
        return array('__isInitialized__', '_synedriasi', '_num', '_recordid', '_aitisi');
    }

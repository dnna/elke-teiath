 ...
 */
class Synedriaseisee_Model_SynedriasiProxy extends \Synedriaseisee_Model_Synedriasi implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::set_start($_start);
    }

    public function get_end()
    {
        $this->__load();
        return parent::get_end();
    }

    public function set_end($_end)
    {
        $this->__load();
        return parent::set_end($_end);
    }
    ...
    {
        $this->__load();
        return parent::get_allDay();
    }

    public function set_allDay($_allDay)
    {
        $this->__load();
        return parent::set_allDay($_allDay);
    }

    public function get_cssClass()
    {
        $this->__load();
        return parent::get_cssClass();
    }

    public function set_cssClass($_cssClass)
    {
        $this->__load();
        return parent::set_cssClass($_cssClass);
    }
    ...
    {
        return array('__isInitialized__', '_num', '_subjects', '_id', '_start', '_end');
    }

 ...
 */
class Aitiseis_Model_OikonomikiDiaxeirisi_Ergou extends \Aitiseis_Model_OikonomikiDiaxeirisi_Ergou implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::get__cs();
    }

    public function get_totalbudget()
    {
        $this->__load();
        return parent::get_totalbudget();
    }

    public function set_totalbudget($_totalbudget)
    {
        $this->__load();
        return parent::set_totalbudget($_totalbudget);
    }

    public function get_teibudget()
    {
        $this->__load();
        return parent::get_teibudget();
    }

    public function set_teibudget($_teibudget)
    {
        $this->__load();
        return parent::set_teibudget($_teibudget);
    }

    public function get_elkededuction()
    {
        $this->__load();
        return parent::get_elkededuction();
    }

    public function set_elkededuction($_elkededuction)
    {
        $this->__load();
        return parent::set_elkededuction($_elkededuction);
    }
    ...
    {
        return array('__isInitialized__', '_aitisiid', '_approved', '_creationdate', '_lastupdatedate', '_title', '_titleen', '_creator', '_session', '_sessionsubject', '_parentaitisi', '_project', '_childrenaitiseis', '_subjects', '_totalbudget', '_teibudget', '_elkededuction', '_partners', '_category', '_budgetitems');
    }

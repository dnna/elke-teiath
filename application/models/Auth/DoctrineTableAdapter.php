<?php
/**
 * From http://victimofbabylon.com/doctrine-2-auth-adapter-for-zendauth
 * Modifed by Dimosthenis Nikoudis <dnna@dnna.gr>
 */
class Application_Model_Auth_DoctrineTableAdapter implements Zend_Auth_Adapter_Interface
{
    /**
    ...
    /**
     *
     * @var Application_Model_Auth_UserCredentials
     */
    protected $_resultidentities;
    ...
    protected function _validateResult($resultIdentities)
    {
        if (count($resultIdentities) < 1) {
            ...
            $this->_resultidentities = $resultIdentities;
            return $this->_authenticateCreateAuthResult();
        } elseif (count($resultIdentities) == 1) {
    ...
    public function get_resultidentities() {
        return $this->_resultidentities;
    }
}
?>